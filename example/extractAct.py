...
for path in compressed_files_path:
    ...
    sub.subscribe_async(logData.update_servo_position, msg_id =pg.messages.ServoPosition)
    sub.subscribe_async(logData.update_set_servo_position, msg_id=pg.messages.SetServoPosition)
    sub.subscribe_async(logData.update_thruster_actuation, msg_id=pg.messages.SetThrusterActuation)
